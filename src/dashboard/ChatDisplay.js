...
const ChatDisplay = () => {
  ...
  return (
    <div className={`${chatDisplay ? 'block' : 'hidden'} md:hidden overflow-y-auto overscroll-y-auto px-3 py-3`}
    // data-aos="fade-left"
    >
        <ImCancelCircle className="text-white text-4xl mb-3 md:hidden" onClick={() => dispatch(setChatView())}/>
      <p>
